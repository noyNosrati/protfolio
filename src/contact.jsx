    ...
    return (
        <div id='contact' className='p-4 pt-10 lg:p-20 flex flex-col items-center justify-center'>
            ...
            <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-2 lg:w-1/2">
                ...
                <textarea className="w-full my-3 rounded-lg bg-[#cfcff0] p-4  b_glow text-xl text-slate-600" placeholder="Write Your Massage..." name="message" cols="20" rows="6"></textarea>
